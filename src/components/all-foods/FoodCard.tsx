    ...
    <article className="group flex h-full min-h-[520px] w-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-emerald-200 hover:shadow-xl hover:shadow-emerald-500/10 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-emerald-900">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <Link
          ...
          className="mt-5 inline-flex h-11 w-full items-center justify-center rounded-xl bg-linear-to-r from-emerald-600 via-emerald-500 to-lime-500 text-sm font-bold text-white shadow-md shadow-emerald-500/20 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-emerald-500/25 active:translate-y-0"
        >
          View Details
        </Link>
      </div>
